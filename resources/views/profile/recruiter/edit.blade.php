...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-3xl mx-auto px-4">
        ...
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-500 mt-1">This information will be visible to candidates and other recruiters.</p>
        </div>
        ...
        <form action="{{route('company.update')}}" method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm px-6 py-5">
                ...
                <div class="flex items-center gap-4">
                    ...
                    {{-- Preview --}}
                    <div id="logo-preview-wrapper" class="w-18 h-18 rounded-xl bg-gray-50 border border-dashed border-gray-300 flex items-center justify-center flex-shrink-0 overflow-hidden" style="width:72px;height:72px;">
                        @if($company->logo)
                            <img id="logo-preview" src="{{ asset('storage/' . $company->logo) }}" alt="Logo" class="w-full h-full object-cover">
                        @else
                            <svg id="logo-placeholder" xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                    ...
                    <div class="flex flex-col gap-1.5">
                        <label for="logo" class="cursor-pointer inline-flex items-center gap-1.5 text-xs font-medium border border-gray-200 rounded-lg px-3.5 py-2 text-gray-600 hover:bg-gray-50 transition w-fit">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm px-6 py-5">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-400 absolute left-3 top-1/2 -translate-y-1/2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-400 mt-1 text-right">
                            <span id="desc-counter">{{ strlen(old('description', $company->description ?? '')) }}</span> / 500
                        </p>
                        @error('description')
                            <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                        @enderror
